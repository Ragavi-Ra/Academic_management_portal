...
public class DashboardController {
    ...
    private void logMessages() {
        ...
        log.error("defaultPageSize value with Environment is : "+environment.getProperty("sasschool_error.pageSize"));
        log.error("successMsg value with Environment is : "+environment.getProperty("sasschool_error.contact.successMsg"));
